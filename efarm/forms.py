...
from efarm.models import UserModel, Crop
...
class SignupForm(ModelForm):
    ...
    class Meta:
        model = UserModel
        fields=['f_name','l_name','mobile','gender','email','type','password','address','zip_code','state','country','dob']
...
class CropForm(ModelForm):
    ...
    class Meta:
        model = Crop
        fields=['crop_name','category','crop_description','crop_image','location','location','contact_no', 'zip_code' , 'state' , 'country'  , 'price' ,'quantity' ]
